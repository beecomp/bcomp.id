defmodule MelliferaWeb.TeamLive.Index do
  ...
  defp apply_action(socket, :edit, %{"id" => id}) do
    ...
    |> assign(:team, Registration.get_team!(id))
  end
  ...
  def handle_event("delete", %{"id" => id}, socket) do
    team = Registration.get_team!(id)
    {:ok, _} = Registration.delete_team(team)

    {:noreply, assign(socket, :teams, list_teams())}
  end

  defp list_teams do
    Registration.list_teams()
  end
end
