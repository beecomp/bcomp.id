...
<div class="bg-gradient-to-b from-stone-700 to-stone-800">
	<div class="bg-no-repeat bg-[left_top_217rem] bg-[length:20rem]" style="background-image: url('/pat-hex-a.png');">
		<div class="bg-no-repeat bg-[right_top_180rem] bg-[length:20rem]" style="background-image: url('/pat-hex-a.png');">
			<div class="bg-no-repeat bg-[left_top_137rem] bg-[length:20rem]" style="background-image: url('/pat-hex-a.png');">
				<div class="bg-no-repeat bg-[right_top_110rem] bg-[length:20rem]" style="background-image: url('/pat-hex-b.png');">
					<div class="bg-no-repeat bg-[left_top_90rem] bg-[length:20rem]" style="background-image: url('/pat-hex-b.png');">
						<div class="bg-no-repeat bg-[right_top_60rem] bg-[length:20rem]" style="background-image: url('/pat-hex-a.png');">
							<div class="bg-no-repeat bg-[left_top_37rem] bg-[length:20rem]" style="background-image: url('/pat-hex-a.png');">
