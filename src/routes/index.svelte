...
<div class="bg-gradient-to-b from-stone-700 to-stone-800">
	<div
		class="bg-no-repeat bg-[left_top_217rem] bg-[length:20rem] hidden md:block"
		style="background-image: url('/pat-hex-a.png');"
	>
		<div
			class="bg-no-repeat bg-[right_top_182rem] bg-[length:20rem] hidden md:block"
			style="background-image: url('/pat-hex-a.png');"
		>
			<div
				class="bg-no-repeat bg-[length:20rem]"
				style="background-image: url('/pat-hex-a.png'); background-position: 0px 2280px; hidden md:block"
			>
				<div
					class="bg-no-repeat bg-[length:20rem]"
					style="background-image: url('/pat-hex-b.png'); background-position: 1050px 1800px; hidden md:block"
				>
					<div
						class="bg-no-repeat bg-[left_top_88rem] bg-[length:20rem] hidden md:block"
						style="background-image: url('/pat-hex-b.png');x"
					>
						<div
							class="bg-no-repeat bg-[right_top_60rem] bg-[length:20rem] hidden md:block"
							style="background-image: url('/pat-hex-a.png');"
						>
							<div
								class="bg-no-repeat bg-[left_top_37rem] bg-[length:20rem] hidden md:block"
								style="background-image: url('/pat-hex-a.png');"
							>
									...
									<div class="max-w-7xl px-4 sm:px-6 lg:px-8 mx-auto space-y-0">
										<div class=" max-w-4xl drop-shadow-lg rounded-md bg-stone-700 p-4 m-4 mx-auto">
											<p class="font-barlow text-xl text-white text-justify">
												...
												bidang Matematika dan IPA tingkat SMP berskala nasional yang akan
												diselenggarakan untuk keempat belas kalinya di SMAK PENABUR Gading Serpong.
												Brilliant Competition sebelumnya diikuti oleh ratusan peserta dari delapan
												provinsi dan lebih dari 50 sekolah yang tersebar di Indonesia.
											</p>
										</div>
