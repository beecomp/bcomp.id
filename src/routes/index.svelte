...
<div class="bg-gradient-to-b from-stone-700 to-stone-800">
	<div
		class="invisible lg:visible bg-no-repeat bg-[left_top_217rem] bg-[length:20rem]"
		style="background-image: url('/pat-hex-a.png');"
	>
		<div
			class="invisible lg:visible bg-no-repeat bg-[right_top_182rem] bg-[length:20rem]"
			style="background-image: url('/pat-hex-a.png');"
		>
			<div
				class="invisible lg:visible bg-no-repeat bg-[length:20rem]"
			...
			>
				...
				>
					<div
						class="invisible lg:visible bg-no-repeat bg-[left_top_88rem] bg-[length:20rem]"
						style="background-image: url('/pat-hex-b.png');x"
					>
						<div
							class="invisible lg:visible bg-no-repeat bg-[right_top_60rem] bg-[length:20rem]"
							style="background-image: url('/pat-hex-a.png');"
						>
							<div
								class="invisible lg:visible bg-no-repeat bg-[left_top_37rem] bg-[length:20rem]"
								style="background-image: url('/pat-hex-a.png');"
							>
