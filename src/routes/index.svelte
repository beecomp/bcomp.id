...
<div class="bg-gradient-to-b from-stone-700 to-stone-800">
	<div
		...
		style="background-image: url('/pat-hex-a.png'); visible md:invisible"
	>
		<div
		...
		>
			<div
				...
				style="background-image: url('/pat-hex-a.png'); background-position: 0px 2280px; visible md:invisible"
			>
				<div
					class="bg-no-repeat bg-[length:20rem]"
					style="background-image: url('/pat-hex-b.png'); background-position: 1050px 1800px; visible md:invisible"
				>
					<div
						class="bg-no-repeat bg-[left_top_88rem] bg-[length:20rem]"
						style="background-image: url('/pat-hex-b.png'); visible md:invisible"
					>
						<div
